...
export declare const SessionEventSchema: z.ZodDiscriminatedUnion<"type", [z.ZodObject<{
    ...
    data: z.ZodObject<{
        legacySession: z.ZodObject<{
            ...
            selectedModel: z.ZodOptional<z.ZodEnum<["claude-sonnet-4.5", "claude-haiku-4.5", "claude-opus-4.5", "claude-sonnet-4", "gpt-5", "gpt-5.1", "gpt-5.1-codex-mini", "gpt-5.1-codex", "gpt-5-mini", "gpt-4.1", "gemini-3-pro-preview"]>>;
        }, "strip", z.ZodTypeAny, {
            sessionId: string;
            startTime: Date;
            chatMessages: ({
            ...
            selectedModel?: "gpt-5" | "gpt-5-mini" | "gpt-4.1" | "claude-sonnet-4.5" | "claude-haiku-4.5" | "claude-sonnet-4" | "claude-opus-4.5" | "gpt-5.1" | "gpt-5.1-codex" | "gpt-5.1-codex-mini" | "gemini-3-pro-preview" | undefined;
        }, {
            sessionId: string;
            startTime: Date;
            chatMessages: ({
...
declare const SUPPORTED_MODELS: readonly ["claude-sonnet-4.5", "claude-haiku-4.5", "claude-opus-4.5", "claude-sonnet-4", "gpt-5", "gpt-5.1", "gpt-5.1-codex-mini", "gpt-5.1-codex", "gpt-5-mini", "gpt-4.1", "gemini-3-pro-preview"];
